...
contract SudokuChallenge {
    ...
    // To be completed in a future PR, assume for now this is correctly implemented
    // This function takes in a 9-by-9 grid representing a potential solution to the `challenge`,
    // and returns `true` if it is a valid solution, `false` otherwise
